...
import com.example.proyectogrupo3.model.*;
...
public class TareaServiceImplement implements TareaService {
    ...
    public ResponseEntity<Map<String, Object>> actualizarTarea(Tarea tarea, Long id) {
        ...
        if (tareaExiste.isPresent()) {
            ...
            // Validar si ya existe otra tarea con el mismo nombre
            if (dao.existsByNombre(tarea.getNombre()) && !tareaGet.getNombre().equals(tarea.getNombre())) {
            ...
            // Respuesta con la tarea actualizada
